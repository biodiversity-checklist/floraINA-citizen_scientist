...
class helper_model extends Database {
    ...
    */
    ...
    {
    	$sql = "SELECT id FROM {$this->prefix}_code_activity WHERE activityValue = '{$action}' LIMIT 1 ";
    	...
    	if ($res){
    		...
    		$ins = "INSERT INTO {$this->prefix}_code_activity_log (userid, activityId, activityDesc, source, datetimes, n_status)
